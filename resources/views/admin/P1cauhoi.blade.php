                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/save-cauhoi')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min10" data-validation-error-msg="Làm ơn điền ít nhất 10 ký tự" name="chitiet_noidung" class="form-control " id="slug" placeholder="Trụ cột/ Thành phần/ Tiêu chí">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Câu hỏi</label>
                                <textarea style="resize: none"  rows="8" class="form-control" name="product_desc" id="ckeditor1" placeholder="Câu hỏi"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Mô tả </label>
                                <textarea style="resize: none"  rows="8" class="form-control" name="product_desc" id="ckeditor1" placeholder="Mô tả về câu hỏi"></textarea>
                            </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Cấp</label>
                              <select name="product_status" class="form-control input-sm m-bot15" onchange="changerID(this)">
