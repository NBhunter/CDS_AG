    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Quản trị CDS-AG </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">Trụ cột</a>
                        <a class="collapse-item" href="login.html">câu hỏi</a>
                        <a class="collapse-item" href="register.html">Thêm Trụ cột</a>
                        <a class="collapse-item" href="{{ URL::to('admin/themcauhoiso1') }}">thêm câu hỏi</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Các kết quả đánh giá:</h6>
