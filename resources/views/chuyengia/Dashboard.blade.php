...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded" style="width:200px; font-size:12px">
                        ...
                        <a class="collapse-item" href="{{ URL::to('chuyengia/P1_ChuaDG') }}">Doanh nghiệp chưa đánh
                            giá</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded" style="width:200px;font-size:12px">
                        ...
                        <a class="collapse-item" href="{{ URL::to('chuyengia/P2_ChuaDG') }}">Doanh nghiệp chưa đánh
                            giá</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded" style="width:200px;font-size:12px">
                        ...
                        <a class="collapse-item" href="{{ URL::to('chuyengia/P3_ChuaDG') }}">Doanh nghiệp chưa đánh
                            giá</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded" style="width:200px;font-size:12px">
                        ...
                        <a class="collapse-item" href="{{ URL::to('chuyengia/P4_ChuaDG') }}">Doanh nghiệp chưa đánh
                            giá</a>
                    ...
                    @if (@isset($home))
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h4 class="mb-0 text-gray-800" style="font-weight:bold;color:#4e73df;">TRANG CHỦ
                                </h4>
                            </div>
                                ...
                                <div class="col-xl-7 col-lg-7">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-4 d-flex flex-row align-items-center justify-content-between"
                                            style="height:40px;">
                                            <h6 class="m-0 font-weight-bold text-primary"
                                                style="position: absolute; left: 30%;">Số lượng đánh giá trong năm
                                            </h6>
    ...
    <div class="text-center p-3" style="background-color: #0038b0;">
        <p style="background: none;text-align: center; color: white; font-size: 14px; margin:5px">© 2023 CHUYỂN ĐỔI SỐ
            TỈNH AN GIANG<span style="padding: 0 15px;">|</span> Thiết kế và Xây dựng bởi <a
