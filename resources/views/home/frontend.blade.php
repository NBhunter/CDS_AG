...
<body>
    <nav
        class="navbar navbar-expand-lg navbar-light bg-light"style="font-family:Roboto; font-weight:bold; font-size: auto;">
        <div class="container">
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
            <div>
                <div class="alert alert-success alert-dismissible fade show"
                    style="color:rgb(81, 255, 0);text-align:center;font-weight:bold;">
...
<footer class=" text-center text-white"
    style="background-image: url({{ asset('img/footer_br-01.jpg') }}) ;background-repeat: no-repeat;   background-position: center;  background-size: cover; width:100%;">
    <!-- Grid container -->
