...
<footer class="bg-light text-center text-white"  style="background-image: url({{asset('img/footer_br-01.jpg')}});" >
  <!-- Grid container -->
  ...
  <section class="" style ="color: #333333;" >
    <div class="container text-center text-md-start mt-5" >
      ...
      <div class="row mt-6">
        <!-- Grid column -->
        <div class="col-md-8 col-lg-9 col-xl-8 ml-0 mb-4">
          <!-- Content -->
        ...
        <!-- Grid column -->
        <div class="col-md-4 col-lg-3 col-xl-4 mr-0 mb-md-0 mb-3 " style="color:white;">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">THÔNG TIN LIÊN HỆ</h6>
          <p><i class="fas fa-home " style="font-weight: bold;"></i>  Long Xuyên, An Giang</p>
          <p>
            <i class="fas fa-envelope "></i>  nrbang_20th@student.agu.edu.vn</p>
          <p><i class="fas fa-phone"></i>  + 01 234 567 88</p>
          <p><i class="fas fa-street-view"></i>  Số lượt truy cập</p>
