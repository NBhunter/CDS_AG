                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse" >
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown has-submenu menu-large hidden-md-down hidden-sm-down hidden-xs-down">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tin theo lĩnh vực</a>
                                <ul class="dropdown-menu megamenu" aria-labelledby="dropdown01">
                                    <li>
                                        <div class="container">
                                            <div class="mega-menu-content clearfix">
                                                <div class="tab">
                                                    <button class="tablinks active" onclick="openCategory(event, 'cat01')">Nông nghiệp</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat02')">Công nghiệp</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat03')">Thương mại - dịch vụ</button>
                                                </div>
                        ...
                        <form class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Tìm kiếm thông tin" aria-label="Search" style="width:250px;">
...
<br><br>
                        <div class="copyright" style="text-align:center;">© 2023 CHUYỂN ĐỔI SỐ TỈNH AN GIANG<span style="padding: 0 15px;">|</span> Thiết kế và Xây dựng bởi <a href="https://fit.agu.edu.vn/" style="color: #00d7eb; font-weight: bold;">FIT - TRƯỜNG ĐH AN GIANG</a></div>
                    </div>
                </div>
            </div><!-- end container -->
